...
## Project Structure
    ...
    ├── testapiautostoryboa_94938  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_94938`
...
2. Clone this repo and `cd testapiautostoryboa_94938`
